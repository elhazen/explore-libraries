...
#MY DIR
#(from_dir <- path_home(path_real(getwd()), "day1_s1_explore-libraries"))
(from_dir <- path_home("/Documents/R/github/RStudio2018", "day1_s1_explore-libraries"))
...
library(tidyverse)
(ft <- tibble(files = dir_ls(from_dir, glob = "*.R")))
ft
